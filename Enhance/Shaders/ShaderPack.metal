...
// MIT licensed — see THIRD_PARTY_NOTICES.md. Copied verbatim so the whole set is available to
// SHADER LAB; the ones that graduate keep working from here, the rest cost nothing at runtime.
// The `bcs_` prefix namespaces these away from Enhance's own shaders in default.metallib.
//
